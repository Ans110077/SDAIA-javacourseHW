...
public class EmployeeController {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public ArrayList<Employee> filterEmployees(EmployeesFilterDTO filter) {
        try {
            return dao.filterEmployees(filter);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    @Path("{empId}")
    @Consumes(MediaType.APPLICATION_JSON)
    public void updateEmployee(@PathParam("empId") int empId,
